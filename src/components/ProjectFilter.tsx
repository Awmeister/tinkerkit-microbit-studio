      ...
      <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className={`flex items-center space-x-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-150 active:scale-[0.99] ${
              statusFilter === 'all'
          ...
          <button
            ...
            className={`flex items-center space-x-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-150 active:scale-[0.99] ${
              statusFilter === 'ready'
                ? 'bg-emerald-950/60 text-emerald-300 border border-emerald-800/60 font-medium shadow-sm'
                : 'bg-slate-900/60 text-emerald-400/80 hover:text-emerald-300 hover:bg-slate-800 border border-emerald-950/60'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-150 active:scale-[0.99] ${
              statusFilter === 'missing_one'
                ? 'bg-amber-950/60 text-amber-300 border border-amber-800/60 font-medium shadow-sm'
                : 'bg-slate-900/60 text-amber-400/80 hover:text-amber-300 hover:bg-slate-800 border border-amber-950/60'
            }`}
          >
      ...
      <div className="flex flex-wrap items-center gap-2 pt-2 border-t border-slate-850">
        ...
        {[
          ...
          <button
            ...
            className={`text-xs px-2.5 py-1 rounded-md transition-all duration-150 active:scale-[0.99] ${
              categoryFilter === cat.id
                ? 'bg-slate-800 text-cyan-300 border border-slate-700 font-medium shadow-sm'
                : 'bg-slate-900/60 text-slate-400 hover:text-slate-200 border border-slate-800'
            }`}
          >
            {cat.label}
